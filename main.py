from transformers import LlavaConfig, CLIPVisionConfig, LlamaConfig
...
def get_words_ids():
    words_to_ids = {'city': 4272, 'tree': 5447, 'mouth': 13394, 'heart': 5192, 'fire': 3974, 'castle': 20610, 'people': 2305, 'anonymous': 21560, 'father': 4783, 'office': 8034, 'software': 7047, 'football': 5733, 'ear': 2326, 'cat': 6635, 'dog': 11203, 'friend': 5121, 'cow': 21282, 'phone': 9008, 'game': 3748, 'person': 2022}
    ids_to_words = {4272: 'city', 5447: 'tree', 13394: 'mouth', 5192: 'heart', 3974: 'fire', 20610: 'castle', 2305: 'people', 21560: 'anonymous', 4783: 'father', 8034: 'office', 7047: 'software', 5733: 'football', 2326: 'ear', 6635: 'cat', 11203: 'dog', 5121: 'friend', 21282: 'cow', 9008: 'phone', 3748: 'game', 2022: 'person'}
...
def test():
    ...
    model = CustomLlavaForConditionalGeneration.from_pretrained("llava-hf/llava-1.5-7b-hf")
    model.to("cuda")
    ...
    for idx, word in enumerate(words):
        ...
        print(processor.batch_decode(generate_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False)[0].strip())
...
def visualize():
    ...
    for word, data in word_and_image_vectors.items():
        vectors.append(data['word'].cpu().detach().numpy())  # Assuming 'word' is a vector
        labels.append(word + " - Word")
        base_words.append(word)
        
        vectors.append(data['image'][0].cpu().detach().numpy())  # Assuming first image vector
    ...
    for i, label in enumerate(labels):
        ...
        plt.scatter(x, y, color=color_map[base_word])  # Use the base word to get the color
